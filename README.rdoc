= redmine_spent_time
<b>Version 3.0.0 tested in Redmine 3.x (Rails 4.2, Ruby 2.2.1)</b>

<b>Download version 2.6.6 for Redmine >= 2.3 & < 3</b>
...
(For version 2.6.6) 2.1 Install required gems (best_in_place is required) with bundler in redmine directory: cd .. && bundle install
