= redmine_spent_time
<b>Version >= 3.0.0 for Redmine 3.x (Rails 4.2, Ruby 2.2.1)</b>

<b>Version 2.6.6 for Redmine >= 2.3 & < 3</b>
...
2. At the command line type <tt>git clone https://github.com/eyp/redmine_spent_time.git[https://github.com/eyp/redmine_spent_time.git]</tt>.
    2.1 (For version 2.6.6 only) Install required gems (best_in_place is required) with bundler in redmine directory: cd .. && bundle install
