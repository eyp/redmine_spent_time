...
Only English, Japanses & Spanish are complete, others need some literals to translate.
...
* @mjanser (Martin Janser), @alexandermeindl (Alexander Meindl): German
* @burci (Peter Buri): Hungarian
* @krewetka (Ania Krawet), @dgutkowsky: Polish
